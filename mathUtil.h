...
public:
  PolynomApprox(uint32_t const aSampleCount, double const * const aSampleY, std::initializer_list<Var> aVarsX);

  PolynomApprox(std::vector<double> const& aSampleY, std::initializer_list<Var> aVarsX) : PolynomApprox(aSampleY.size(), aSampleY.data(), aVarsX) {}
