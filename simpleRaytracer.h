...
public:
  Medium(StepperType const aStepper,
         ...
         double const aDistAlongRay, double const aTolAbs, double const aTolRel, double const aStep1, double const aStepMax, Object const& aObject)
  : mEikonal(aEarthForm, aModel, aTempAmbient, aTempBase)
  , mSolver(aStepper, aDistAlongRay, aTolAbs, aTolRel, aStep1, aStepMax, mEikonal)
  , mObject(aObject) {}
